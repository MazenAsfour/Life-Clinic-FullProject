  ...
  <li class="mazen2">
    ...
    <li>
      <a href="javascript:;">
        ...
        <li><a href="qexam.php"class="active" >تعديل وصف الدخول الى الاختبار  </a></li>
    ...
    <div class="main-panel" style="height: 200vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        ...
        <label for=""> اللوغو  </label>
          <input type="text" name="logo"style="text-align:right" id=""readonly value='<?php echo $logo;?>' class='form-control'>
          <label for=""> وصف الدخول الى الاختبار </label>
          <input type="text" name="a11" id=""style="text-align:right" value='<?php echo $welcometest;?>' class='form-control'>
          <label for=""> اسم الاختبار </label>
          <input type="text" name="testname" id=""style="text-align:right" value='<?php echo $testname;?>' class='form-control'> 
          <label for=""> اسم المقياس </label>
          <input type="text" name="bek" id=""style="text-align:right" value='<?php echo $bek;?>' class='form-control'>
          <label for="">  وصف المقياس </label>
          <input type="text" name="bektext" id=""style="text-align:right" value='<?php echo $bektext;?>' class='form-control'>
          <input type="submit" value="Edit" name='qexam' class='btn btn-success text-center'>
          </form>   
