  ...
  <li class="mazen2">
    ...
    <li>
        ...
        <ul class="list4">
          ...
          <li><a href="thera.php" class="list h active">جلسات الثيرابيست</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <label for=""> صورة العيادة </label>
          <input type="text" name="header"style="text-align:right"  id="" value='<?php echo $aboutheader3;?>' class='form-control'>
          <label for="">الوصف </label>
          <input type="text" name="text"style="text-align:right" id="" value='<?php echo $abouttext3;?>' class='form-control'>
          <input type="submit" value="Edit" name='thera' class='btn btn-success text-center'>
          </form>   
      </div>
