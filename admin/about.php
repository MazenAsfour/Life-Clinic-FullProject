...
<div class="sidebar-wrapper">
  ...
  <li class="mazen2">
    ...
    <li>
        ...
        <ul class="list4">
          <li><a href="about.php" class="list h active">وصف العيادة والصورة </a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="file" name="img"  id="" value='<?php echo $aboutimg1;?>' class='form-control'>
          <label for="">الوصف </label>
          <input type="text" name="text" id="" value='<?php echo $aboutheader1;?>' class='form-control'>
          <input type="submit" value="Edit" name='about' class='btn btn-success text-center'>
          </form>   
      </div>
