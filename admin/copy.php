...
if(isset($_GET['delete'])){
  $id=$_GET['id'];
  $query="delete from backupsapp where id='$id'";
  mysqli_query($conn,$query);
  header("REFRESH:0;url=copy.php");
}
...
<div class="sidebar-wrapper">
  ...
  <li class="mazen2">
        ...
        <p  class=" mazen1 active" id="maz">معلومات الموقع <bold class="a"><</bold></p></a>
    ...
    <div class="main-panel" style="height: 400vh;text-align: right;width:82% !important;">
      ...
      <?php 
        ...
        $tableuser="SELECT * from backupsapp ORDER BY sessiondate DESC";
        ...
        while($fetchtable=mysqli_fetch_array($tableuserrun)){
            ...
            <td class='date1'>".$fetchtable['sessiondate']."</td><td style='display:flex;margin-right:1.2vw; 
            border-bottom:none;border-left:none; margin-right:-.03vw' >
           
             <form action='copy.php'><input type='submit' class='btn btn-danger deletetablebtn'
