...
<div class="sidebar-wrapper">
  ...
  <li class="mazen2">
        ...
        <p  class=" mazen1 " id="maz">معلومات الموقع <bold class="a active"><</bold></p></a>
      ...
      <a href="javascript:;">
        ...
        <ul class="first " id="one">
          ...
          <ul class="fut" style="display: none;">
            ...
            <li><a href="f4.php" class="active">تعديل الميزة الرابعة</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:83% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          <label for="">اسم الميزة </label>
          <input type="text" name="header"style="text-align:right"  id="" value='<?php echo $f4header;?>' class='form-control'>
          <label for="">وصف الميزة</label>
          <input type="text" name="text" id=""style="text-align:right" value='<?php echo $f4text;;?>' class='form-control'>
          <input type="submit" value="Edit" name='f4' class='btn btn-success text-center'>
          </form>   
      </div>
