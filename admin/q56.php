  ...
  <li class="mazen2">
    ...
    <li>
      <a href="javascript:;">
        ...
        <p><a class="f h ques1 active" style="cursor: pointer;">اختبر نفسك</a><bold class="a " style="left:14px"><</bold></p>
        ...
        <li><a href="qexam.php" >تعديل وصف الدخول الى الاختبار  </a></li>
          ...
          <li><a href="q56.php"class="active">تعديل السؤال الخامس والسادس</a></li>
    ...
    <div class="main-panel" style="height: 200vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        ...
        <label for=""> السؤال الخامس </label>
          <input type="text" name="q11"style="text-align:right" id="" value='<?php echo $q5;?>' class='form-control'>
          <label for=""> الأجابة الأولى     </label>
          <input type="text" name="a1" id=""style="text-align:right" value='<?php echo $q51;?>' class='form-control'>
          <label for=""> الأجابة الثانية  </label>
          <input type="text" name="a2" id=""style="text-align:right" value='<?php echo $q52;?>' class='form-control'> 
          <label for=""> الأجابة الثالثة  </label>
          <input type="text" name="a3" id=""style="text-align:right" value='<?php echo $q53;?>' class='form-control'>
          <label for=""> الاجابة الرابعة  </label>
          <input type="text" name="a4" id=""style="text-align:right" value='<?php echo $q54;?>' class='form-control'>

          <input type="submit" value="Edit" name='q5' class='btn btn-success text-center'>
          </form>   
          <img src="divider.svg" style="width:70%;margin:1vw 9vw" alt="">
          <form action="<?php echo $_SERVER['PHP_SELF'];?>">
        <label for=""> السؤال السادس </label>
          <input type="text" name="q11"style="text-align:right" id="" value='<?php echo $q6;?>' class='form-control'>
          <label for=""> الأجابة الأولى     </label>
          <input type="text" name="a1" id=""style="text-align:right" value='<?php echo $q61;?>' class='form-control'>
          <label for=""> الأجابة الثانية  </label>
          <input type="text" name="a2" id=""style="text-align:right" value='<?php echo $q62;?>' class='form-control'> 
          <label for=""> الأجابة الثالثة  </label>
          <input type="text" name="a3" id=""style="text-align:right" value='<?php echo $q63;?>' class='form-control'>
          <label for=""> الاجابة الرابعة  </label>
          <input type="text" name="a4" id=""style="text-align:right" value='<?php echo $q64;?>' class='form-control'>

          <input type="submit" value="Edit" name='q6' class='btn btn-success text-center'>
            </form>
      </div>
