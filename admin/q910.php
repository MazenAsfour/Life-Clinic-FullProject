  ...
  <li class="mazen2">
    ...
    <li>
      <a >
        ...
        <ul class="list2" > 
          <li><a href="ser21.php" class="list h ">تعديل الخدمة الأولى</a></li>
          <li><a href="ser22.php" class="list h">تعديل الخدمة الثانية</a></li>
          <li><a href="ser23.php" class="list h">تعديل الخدمة الثالثة</a></li>
          <li><a href="ser24.php" class="list h">تعديل الخدمة الرابعة </a></li>
    ...
    <li>
        <a href="javascript:;">
        <i class="nc-icon nc-diamond"></i>
        <p onclick="show4()" class="cl4 h ">معلومات عنا <bold class="a active"><</bold></p></a>
        <ul class="list4">
    ...
    <li>
      <a href="javascript:;">
        ...
        <p><a class="f h ques1 active" style="cursor: pointer;">اختبر نفسك</a><bold class="a active" style="left:14px"><</bold></p>
        ...
        <li><a href="qexam.php" >تعديل وصف الدخول الى الاختبار  </a></li>
          ...
          <li><a href="q910.php"class="active">تعديل السؤال التاسع والعاشر</a></li>
        </ul>
      </li>
      <li>
        <a href="">
    ...
    <div class="main-panel" style="height: 200vh;text-align: right;width:82% !important;">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand header1"style='color:#745b19' >اختبر نفسك   </a><span class="con">              <i class="nc-icon nc-bank"></i>
            </span>
      ...
      <?php // style="text-align:right"?>
        ...
        <label for=""> السؤال التاسع </label>
          <input type="text" name="q11"style="text-align:right" id="" value='<?php echo $q9;?>' class='form-control'>
          <label for=""> الأجابة الأولى     </label>
          <input type="text" name="a1" id=""style="text-align:right" value='<?php echo $q91;?>' class='form-control'>
          <label for=""> الأجابة الثانية  </label>
          <input type="text" name="a2" id=""style="text-align:right" value='<?php echo $q92;?>' class='form-control'> 
          <label for=""> الأجابة الثالثة  </label>
          <input type="text" name="a3" id=""style="text-align:right" value='<?php echo $q93;?>' class='form-control'>
          <label for=""> الاجابة الرابعة  </label>
          <input type="text" name="a4" id=""style="text-align:right" value='<?php echo $q94;?>' class='form-control'>

          <input type="submit" value="Edit" name='q9' class='btn btn-success text-center'>
          </form>   
          <img src="divider.svg" style="width:70%;margin:1vw 9vw" alt="">
          <form action="<?php echo $_SERVER['PHP_SELF'];?>">
        <label for=""> السؤال العاشر </label>
          <input type="text" name="q11"style="text-align:right" id="" value='<?php echo $q10;?>' class='form-control'>
          <label for=""> الأجابة الأولى     </label>
          <input type="text" name="a1" id=""style="text-align:right" value='<?php echo $q101;?>' class='form-control'>
          <label for=""> الأجابة الثانية  </label>
          <input type="text" name="a2" id=""style="text-align:right" value='<?php echo $q102;?>' class='form-control'> 
          <label for=""> الأجابة الثالثة  </label>
          <input type="text" name="a3" id=""style="text-align:right" value='<?php echo $q103;?>' class='form-control'>
          <label for=""> الاجابة الرابعة  </label>
          <input type="text" name="a4" id=""style="text-align:right" value='<?php echo $q104;?>' class='form-control'>

          <input type="submit" value="Edit" name='q10' class='btn btn-success text-center'>
            </form>
      </div>
