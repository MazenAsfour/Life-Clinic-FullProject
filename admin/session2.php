      ...
      <a href="javascript:;">
        ...
        <ul class="first " id="one">
          ...
          <ul class="prices" style="display: none;">
            ...
            <li><a href="session2.php" class="active">تعديل الجلسة الثانية</a></li>
    ...
    <div class="main-panel" style="height: 180vh;text-align: right;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="number" name="price"style="text-align:right" id="" value='<?php echo $session2price;?>' class='form-control'>
          <label for="">الوقت</label>
          <input type="text" name="time"  id="" value='<?php echo $session1det2;?>' class='form-control'>
          <label for="">الخاصية الاولى</label>
          <input type="text" name="text1"style="text-align:right"  id="" value='<?php echo $session2det2;?>' class='form-control'>
          <label for="">الخاصية الثانية</label>
          <input type="text" name="text2"style="text-align:right"  id="" value='<?php echo $session3det2;?>' class='form-control'>
          <label for="">الخاصية الثالثة</label>
          <input type="text" name="text3" style="text-align:right" id="" value='<?php echo $session4det2;?>' class='form-control'>
          <label for="">الخاصية الرابعة</label>
          <input type="text" name="text4" style="text-align:right" id="" value='<?php echo $session5det2;?>' class='form-control'>
          
          <input type="submit" value="Edit" name='session2' class='btn btn-success text-center'>
          </form>   
      </div>
