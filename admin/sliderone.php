    ...
    <li>
      <a href="javascript:;">
        ...
        <ul class="first " id="one">
          ...
          <li class=""><a href="sliderone.php "class="active">تعديل سلايدر الأول</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="text"style="text-align:right"  id="" value='<?php echo $slideronetext1;?>' class='form-control'>
          <label for="">الصورة</label>
          <input type="file" name="img" id="" value='<?php echo $slideroneimg1;?>' class='form-control'>
          <input type="submit" value="Edit" name='sliderone' class='btn btn-success text-center'>
          </form>   
      </div>
