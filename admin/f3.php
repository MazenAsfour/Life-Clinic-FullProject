      ...
      <a href="javascript:;">
        ...
        <ul class="first " id="one">
          ...
          <ul class="fut" style="display: none;">
            ...
            <li><a href="f3.php" class="active">تعديل الميزة الثالثة</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:83% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="header"style="text-align:right"  id="" value='<?php echo $f3header;?>' class='form-control'>
          <label for="">وصف الميزة</label>
          <input type="text" name="text" id=""style="text-align:right" value='<?php echo $f3text;;?>' class='form-control'>
          <input type="submit" value="Edit" name='f3' class='btn btn-success text-center'>
          </form>   
      </div>
