...
<div class="sidebar-wrapper">
  ...
  <li class="mazen2">
    ...
    <li>
      <a href="javascript:;">
        ...
        <ul class="first " id="one">
          ...
          <li><a  class="list h  fut1 active">ميزات العيادة  <bold class="ab active"><</bold></a>
          <ul class="fut" style="display: none;">
            <li><a href="feuturedesc.php"class="active">تعديل الوصف</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:83% !important;">
      <!-- Navbar -->
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="header"style="text-align:right"  id="" value='<?php echo $featureheader;?>' class='form-control'>
          <label for="">وصف المحتوى</label>
          <input type="text" name="text" id=""style="text-align:right" value='<?php echo $featureheadertext;;?>' class='form-control'>
          <label for="">الصورة الجانبية</label>
          <input type="file" name="img" id=""style="text-align:right" value='<?php echo $featureimage;;?>' class='form-control'>
          <input type="submit" value="Edit" name='editfeature' class='btn btn-success text-center'>
          </form>   
      </div>
