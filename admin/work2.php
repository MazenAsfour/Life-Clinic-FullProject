    ...
    <li>
      <a href="javascript:;">
        ...
        <ul class="first " id="one">
          ...
          <li><a  class="list h  work1 active">دليل الوظائف والعمل<bold class="ab active"><</bold></a>
          <ul class="work" style="display: none;">
            ...
            <li><a href="work2.php"class="active">تعديل الخطوة الثانية</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="header"style="text-align:right"  id="" value='<?php echo $work2header;?>' class='form-control'>
          <label for="">وصف المحتوى</label>
          <input type="text" name="text" id=""style="text-align:right" value='<?php echo $work2des;;?>' class='form-control'>
          <label for="">الصورة</label>
          <input type="file" name="img" id=""style="text-align:right" value='<?php echo $work2img;;?>' class='form-control'>
          <input type="submit" value="Edit" name='work2' class='btn btn-success text-center'>
          </form>   
      </div>
