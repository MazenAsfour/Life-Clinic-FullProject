...
<div class="sidebar-wrapper" style="position:relative">
  ...
  <li class="mazen2">
    ...
    <li>
        <a href="javascript:;">
        <i class="nc-icon nc-diamond"></i>
        <p  class="cl4 h">معلومات عنا <bold class="a"><</bold></p></a>
        <ul class="list4">
    ...
    <li>
      ...
      <li>
       ...
       <li>
        <a href="javascript:;">
        <i class="nc-icon nc-diamond"></i>
        <p onclick="show4()" class="advice h active"> تصنيفات الاختبار والنصائح<bold class="a active"><</bold></p></a>
        <ul class="advice1" style="display:none">
          ...
          <li><a href="advice4.php" class="list h active">الاكتئاب الشديد</a></li>
    ...
    <div class="main-panel" style="height: 110vh;text-align: right;">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand header1"style='color:#745b19' >اكتئاب شديد </a><span class="con">              <i class="nc-icon nc-bank"></i>
            </span>
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="a1"style="text-align:right"  id="" value='<?php echo $advice41;;?>' class='form-control'>
          <label for="">النصيحة الثانية </label>
          <input type="text" name="a2"style="text-align:right" id="" value='<?php echo $advice42;?>' class='form-control'>
          <label for="">النصيحة الثالثة</label>
          <input type="text" name="a3"style="text-align:right"  id="" value='<?php echo $advice43;?>' class='form-control'>
          <label for=""> النصيحة الرابعة</label>
          <input type="text" name="a4"style="text-align:right"  id="" value='<?php echo $advice44;?>' class='form-control'>
     
          <input type="submit" value="Edit" name='advice4' class='btn btn-success text-center'>
          </form>   
      </div>
