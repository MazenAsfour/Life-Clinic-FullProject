  ...
  <li class="mazen2">
    ...
    <li>
      ...
      <li>
        ...
        <li><a href="know3.php"class="active">ألاسباب وعوامل الخطورة</a></li>
    ...
    <div class="main-panel" style="height: 150vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="header"style="text-align:right"  id="" value='<?php echo $reason;?>' class='form-control'>
          <label for="">   السبب الأول</label>
          <input type="text" name="r1" id=""style="text-align:right" value='<?php echo $reason1;;?>' class='form-control'>
          <label for="">السبب التاني  </label>
          <input type="text" name="r2" id=""style="text-align:right" value='<?php echo $reason2;;?>' class='form-control'>
          <label for="">  السبب الثالث </label>
          <input type="text" name="r3" id=""style="text-align:right" value='<?php echo $reason3;;?>' class='form-control'>
          <label for="">السبب الرابع </label>
          <input type="text" name="r4" id=""style="text-align:right" value='<?php echo $reason4;;?>' class='form-control'>
        
    
          <input type="submit" value="Edit" name='know3' class='btn btn-success text-center'>
          </form>   
      </div>
