      ...
      <a href="javascript:;">
        ...
        <ul class="first " id="one">
          ...
          <ul class="fut" style="display: none;">
            ...
            <li><a href="f1.php" class="active">تعديل الميزة الأولى</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:83% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="header"style="text-align:right"  id="" value='<?php echo $f1header;?>' class='form-control'>
          <label for="">وصف الميزة</label>
          <input type="text" name="text" id=""style="text-align:right" value='<?php echo $f1text;;?>' class='form-control'>
          <input type="submit" value="Edit" name='f1' class='btn btn-success text-center'>
          </form>   
      </div>
