    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="name"  id="" value='<?php echo $lifeclinic;?>' class='form-control'>
          <label for="">اللوغو</label>
          <input type="file" name="logo" id="" value='<?php echo $logo;?>' class='form-control'>
          <input type="submit" value="Edit" name='infowebsite' class='btn btn-success text-center'>
          </form>   
      </div>
