    ...
    <li>
      <a href="javascript:;">
        ...
        <ul class="first " id="one">
          ...
          <li><a  class="list h feedback1 active">التغذية الراجعة  <bold class="ab active"><</bold></a>
          <ul class="feedback" style="display: none;">
            ...
            <li><a href="feed4.php"class="active">تعديل التغذية الرابعة</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          <label for="">اسم الشخص  </label>
          <input type="text" name="name"style="text-align:left"  id="" value='<?php echo $fdname4;?>' class='form-control'>
          <label for="">صورة الشخص </label>
          <input type="file" name="img" id=""style="text-align:right" value='<?php echo $fdphoto4;;?>' class='form-control'>
            <label for="">التعليقات</label>
          <input type="text" name="comment" id=""style="text-align:right" value='<?php echo $fdtext4;;?>' class='form-control'>
        
          <input type="submit" value="Edit" name='feed4' class='btn btn-success text-center'>
          </form>   
      </div>
