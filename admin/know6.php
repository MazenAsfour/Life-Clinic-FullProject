  ...
  <li class="mazen2">
    ...
    <li>
      ...
      <li>
        ...
        <li><a href="know6.php"class="active">ارشادات التعامل مع الاكتئاب</a></li>
    ...
    <div class="main-panel" style="height: 150vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="header"style="text-align:right"  id="" value='<?php echo $how;?>' class='form-control'>
          <label for=""> الأرشاد الاول </label>
          <input type="text" name="r1" id=""style="text-align:right" value='<?php echo $how1;;?>' class='form-control'>
          <label for=""> الأرشاد التاني   </label>
          <input type="text" name="r2" id=""style="text-align:right" value='<?php echo $how2;;?>' class='form-control'>
          <label for=""> الأرشاد الثالث</label>
          <input type="text" name="r3" id=""style="text-align:right" value='<?php echo $how3;;?>' class='form-control'>
         
          <input type="submit" value="Edit" name='know6' class='btn btn-success text-center'>
          </form>   
      </div>
