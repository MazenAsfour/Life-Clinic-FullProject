  ...
  <li class="mazen2">
    ...
    <li>
      ...
      <li>
        ...
        <li><a href="know4.php"class="active">أعراض المرض</a></li>
    ...
    <div class="main-panel" style="height: 150vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="header"style="text-align:right"  id="" value='<?php echo $marks;?>' class='form-control'>
          <label for=""> الأعراض الاولى</label>
          <input type="text" name="r1" id=""style="text-align:right" value='<?php echo $mark1;;?>' class='form-control'>
          <label for="">الأعراض التانية   </label>
          <input type="text" name="r2" id=""style="text-align:right" value='<?php echo $mark2;;?>' class='form-control'>
          <label for="">  الأعراض الثالثة  </label>
          <input type="text" name="r3" id=""style="text-align:right" value='<?php echo $mark3;;?>' class='form-control'>
          <label for="">الاعراض الرابعة  </label>
          <input type="text" name="r4" id=""style="text-align:right" value='<?php echo $mark4;;?>' class='form-control'>
          <label for=""> الأعراض الخامسة </label>
          <input type="text" name="r5" id=""style="text-align:right" value='<?php echo $mark5;;?>' class='form-control'> 
    
          <input type="submit" value="Edit" name='know4' class='btn btn-success text-center'>
          </form>   
      </div>
