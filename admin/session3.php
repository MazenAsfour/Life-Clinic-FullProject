  ...
  <li class="mazen2">
    ...
    <li>
      <a href="javascript:;">
        ...
        <ul class="first " id="one">
          ...
          <li><a  class="list h prices1 ">اسعار الجلسات  <bold class="ab active"><</bold></a>
          ...
          <li><a  class="list h doctor1 active">دليل الدكاترة <bold class="ab"><</bold></a>
          <ul class="doctor" style="display: none;">
          <li><a href="doctordesc.php">تعديل الوصف</a></li>
          <li><a href="doctor1.php"class="active">تعديل الدكتور الأول</a></li>
    ...
    <div class="main-panel" style="height: 180vh;text-align: right;">
      ...
      <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="number" name="price"style="text-align:right" id="" value='<?php echo $session3price;?>' class='form-control'>
          <label for="">الوقت</label>
          <input type="text" name="time"  id="" value='<?php echo $session1det3;?>' class='form-control'>
          <label for="">الخاصية الاولى</label>
          <input type="text" name="text1"style="text-align:right"  id="" value='<?php echo $session2det3;?>' class='form-control'>
          <label for="">الخاصية الثانية</label>
          <input type="text" name="text2"style="text-align:right"  id="" value='<?php echo $session3det3;?>' class='form-control'>
          <label for="">الخاصية الثالثة</label>
          <input type="text" name="text3" style="text-align:right" id="" value='<?php echo $session4det3;?>' class='form-control'>
          <label for="">الخاصية الرابعة</label>
          <input type="text" name="text4" style="text-align:right" id="" value='<?php echo $session5det3;?>' class='form-control'>
          
          <input type="submit" value="Edit" name='session3' class='btn btn-success text-center'>
          </form> 
      </div>
