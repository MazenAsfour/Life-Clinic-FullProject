      ...
      <a href="javascript:;">
        ...
        <ul class="first " id="one">
          ...
          <ul class="feedback" style="display: none;">
            ...
            <li><a href="feed3.php"class="active">تعديل التغذية الثالثة</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="name"style="text-align:left"  id="" value='<?php echo $fdname3;?>' class='form-control'>
          <label for="">صورة الشخص </label>
          <input type="file" name="img" id=""style="text-align:right" value='<?php echo $fdphoto3;;?>' class='form-control'>
            <label for="">التعليقات</label>
          <input type="text" name="comment" id=""style="text-align:right" value='<?php echo $fdtext3;;?>' class='form-control'>
        
          <input type="submit" value="Edit" name='feed3' class='btn btn-success text-center'>
          </form>   
      </div>
