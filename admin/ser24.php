...
<head>
  ...
  <title>
   edit subwebite services-service 4
  </title>
...
<div class="sidebar-wrapper">
  ...
  <li class="mazen2">
        ...
        <ul class="mazen" style="display:none">
          <li><a href="adminsite.php" class="list h active">أسم العيادة واللوغو</a></li>
    ...
    <li>
      <a >
        <i class="nc-icon nc-diamond"></i>
        <p  class="cl2 active">الخدمات <bold class="a active"><</bold></p></a>
        <ul class="list2" > 
          ...
          <li><a href="ser24.php" class="list h active">تعديل الخدمة الرابعة </a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand header1"style='color:#745b19' > الخدمات  </a><span class="con">              <i class="nc-icon nc-bank"></i>
            </span>
      ...
      <?php // style="text-align:right"?>
        ...
        <label for=""> اسم الخدمة الرابعة</label>
          <input type="text" name="" style="text-align:right" id="" value='<?php echo $ser4;?>' class='form-control' readonly>
          <label for=""> صورة الخدمة الرابعة</label>
          <input type="file" name="img"  id="" value='<?php echo $seradvimg4;?>' class='form-control'>
          <label for="">الوصف </label>
          <input type="text" name="text" id="" value='<?php echo $seradv4;?>' class='form-control'>
          <input type="submit" value="Edit" name='ser24' class='btn btn-success text-center'>
          </form>   
      </div>
