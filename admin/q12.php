  ...
  <li class="mazen2">
    ...
    <li>
      <a href="javascript:;">
        ...
        <li><a href="qexam.php" >تعديل وصف الدخول الى الاختبار  </a></li>
          <li><a href="q12.php" class="active">تعديل السؤال الأول والتاني</a></li>
    ...
    <div class="main-panel" style="height: 200vh;text-align: right;width:82% !important">
      ...
      <?php // style="text-align:right"?>
        ...
        <label for=""> السؤال الأول </label>
          <input type="text" name="q11"style="text-align:right" id="" value='<?php echo $q1;?>' class='form-control'>
          <label for=""> الأجابة الأولى     </label>
          <input type="text" name="a1" id=""style="text-align:right" value='<?php echo $q11;?>' class='form-control'>
          <label for=""> الأجابة الثانية  </label>
          <input type="text" name="a2" id=""style="text-align:right" value='<?php echo $q12;?>' class='form-control'> 
          <label for=""> الأجابة الثالثة  </label>
          <input type="text" name="a3" id=""style="text-align:right" value='<?php echo $q13;?>' class='form-control'>
          <label for=""> الاجابة الرابعة  </label>
          <input type="text" name="a4" id=""style="text-align:right" value='<?php echo $q14;?>' class='form-control'>

          <input type="submit" value="Edit" name='q1' class='btn btn-success text-center'>
          </form>   
          <img src="divider.svg" style="width:70%;margin:1vw 9vw" alt="">
          <form action="<?php echo $_SERVER['PHP_SELF'];?>">
        <label for=""> السؤال الثاني </label>
          <input type="text" name="q11"style="text-align:right" id="" value='<?php echo $q2;?>' class='form-control'>
          <label for=""> الأجابة الأولى     </label>
          <input type="text" name="a1" id=""style="text-align:right" value='<?php echo $q21;?>' class='form-control'>
          <label for=""> الأجابة الثانية  </label>
          <input type="text" name="a2" id=""style="text-align:right" value='<?php echo $q22;?>' class='form-control'> 
          <label for=""> الأجابة الثالثة  </label>
          <input type="text" name="a3" id=""style="text-align:right" value='<?php echo $q23;?>' class='form-control'>
          <label for=""> الاجابة الرابعة  </label>
          <input type="text" name="a4" id=""style="text-align:right" value='<?php echo $q24;?>' class='form-control'>

          <input type="submit" value="Edit" name='q2' class='btn btn-success text-center'>
            </form>
      </div>
