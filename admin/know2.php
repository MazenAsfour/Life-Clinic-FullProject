  ...
  <li class="mazen2">
    ...
    <li>
      ...
      <li>
        <a href="">
        <i class="nc-icon nc-diamond"></i></a>
        <p ><a class="f h know1 active" style="cursor: pointer;">ثقف نفسك<bold class="a active" style="left:14px;top:-4px"><</bold></a>
        </p>
        <ul class="know active" style="display: none;">
        <li><a href="know1.php">الصورة والوصف والافادة</a></li>
        <li><a href="know2.php"class="active">أنواع الاكتئاب</a></li>
    ...
    <div class="main-panel" style="height: 200vh;text-align: right;width:82% !important;">
      <!-- Navbar -->
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand header1"style='color:#745b19 ' > ثقف نفسك   </a><span class="con">              <i class="nc-icon nc-bank"></i>
            </span>
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="header"style="text-align:right"  id="" value='<?php echo $typedes;?>' class='form-control'>
          <label for="">اسم الاكتئاب الاول </label>
          <input type="text" name="h1" id=""style="text-align:right" value='<?php echo $typeheader1;;?>' class='form-control'>
          <label for="">وصف الاكتئاب الأول</label>
          <input type="text" name="t1" id=""style="text-align:right" value='<?php echo $typetext1;;?>' class='form-control'>
          <label for="">اسم الاكتئاب الثاني </label>
          <input type="text" name="h2" id=""style="text-align:right" value='<?php echo $typeheader2;;?>' class='form-control'>
          <label for="">وصف الاكتئاب الثاني</label>
          <input type="text" name="t2" id=""style="text-align:right" value='<?php echo $typetext2;;?>' class='form-control'>
          <label for="">اسم الاكتئاب الثالث </label>
          <input type="text" name="h3" id=""style="text-align:right" value='<?php echo $typeheader3;;?>' class='form-control'>
          <label for="">وصف الاكتئاب الثالث</label>
          <input type="text" name="t3" id=""style="text-align:right" value='<?php echo $typetext3;;?>' class='form-control'>
          <label for="">اسم الاكتئاب الرابع </label>
          <input type="text" name="h4" id=""style="text-align:right" value='<?php echo $typeheader4;;?>' class='form-control'>
          <label for="">وصف الاكتئاب الرابع</label>
          <input type="text" name="t4" id=""style="text-align:right" value='<?php echo $typetext4;;?>' class='form-control'>
          <label for="">اسم الاكتئاب الخامس </label>
          <input type="text" name="h5" id=""style="text-align:right" value='<?php echo $typeheader5;;?>' class='form-control'>
          <label for=""> وصف الاكتئاب الخامس</label>
          <input type="text" name="t5" id=""style="text-align:right" value='<?php echo $typetext5;;?>' class='form-control'>
          <label for="">وصف المحتوى</label>
          <input type="text" name="text" id=""style="text-align:right" value='<?php echo $lastdif;;?>' class='form-control'>
          <input type="submit" value="Edit" name='know2' class='btn btn-success text-center'>
          </form>   
      </div>
