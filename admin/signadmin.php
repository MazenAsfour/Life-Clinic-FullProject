...
<div class="sidebar-wrapper">
  ...
  <li class="mazen2">
        ...
        <ul class="mazen" style="display:none">
          ...
          <li><a href="healthuser.php" class="list h">التقييم الصحي للمستخدمين</a></li>
          <li><a href="signadmin.php" class="list h active">وصف الخروج والدخول</a></li>
    ...
    <div class="main-panel" style="height: 150vh;text-align: right;width:82% !important;">
      <!-- Navbar -->
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          <label for="">تسجيل الدخول  </label>
          <input type="text" name="log"style="text-align:left"  id="" value='<?php echo $logheader;?>' class='form-control'>
          <label for="">  وصف تسجيل الدخول </label>
          <input type="text" name="logtext" id=""style="text-align:right" value='<?php echo $logtext;;?>' class='form-control'>
          <label for="">  تسجيل حساب جديد   </label>
          <input type="text" name="sign" id=""style="text-align:left" value='<?php echo $signheader;;?>' class='form-control'>
          <label for=""> وصف تسجيل حساب جديد </label>
          <input type="text" name="signtext" id=""style="text-align:right" value='<?php echo $signtext;;?>' class='form-control'>
          <label for="">  تعديل المعلومات الشخصية </label>
          <input type="text" name="edit" id=""style="text-align:left" value='<?php echo $editprofile;?>' class='form-control'>
          <label for=""> وصف تعديل المعلومات الشخصية   </label>
          <input type="text" name="edittext" id=""style="text-align:right" value='<?php echo $editprofiletext;?>' class='form-control'>
          <input type="submit" value="Edit" name='signadmintext' class='btn btn-success text-center'>
          </form>   
      </div>
