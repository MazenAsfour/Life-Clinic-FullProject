    ...
    <li>
      <a href="javascript:;">
        ...
        <ul class="first " id="one">
          <li><a class="list h  detail1 active">السلايدر الترحيبي <bold class="ab active"><</bold></a>
          ...
          <li class=""><a href="sliderthree.php " class="active">تعديل سلايدر الثالث</a></li>
          </ul>
          </li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          <label for="">العبارة</label>
          <input type="text" name="text" style="text-align:right" id="" value='<?php echo $slideronetext3;?>' class='form-control'>
          <label for="">الصورة</label>
          <input type="file" name="img" id="" value='<?php echo $slideroneimg3;?>' class='form-control'>
          <input type="submit" value="Edit" name='sliderthree' class='btn btn-success text-center'>
          </form>   
      </div>
