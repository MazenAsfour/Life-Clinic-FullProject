  ...
  <li class="mazen2">
    ...
    <li>
        ...
        <ul class="list4">
          ...
          <li><a href="person.php" class="list h active">التقييم النفسي</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        ...
        <label for="">العنوان </label>
          <input type="text" name="header"style="text-align:right" id="" value='<?php echo $aboutheader2;?>' class='form-control'>
          <label for=""> الصورة  </label>
          <input type="file" name="img"style="text-align:right"  id="" value='<?php echo $aboutimg2;?>' class='form-control'>
          <label for="">الوصف </label>
          <input type="text" name="text" id="" value='<?php echo $abouttext2;?>' class='form-control'>
          <input type="submit" value="Edit" name='person' class='btn btn-success text-center'>
          </form>   
      </div>
