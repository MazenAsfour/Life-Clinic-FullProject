...
if(isset($_GET['editadmin'])){
    ...
    if( $error2=='false' && $error3=='false'){
        ...
        $queryadd="UPDATE admins set Email='$newemail',
        Password='$newpassword' where FullName='$admin'";
        mysqli_query($conn,$queryadd);
        $success="<div class='green'>Edited successfully
  ...
  <li class="mazen2">
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand header1"style='color:#745b19' > تعديل معلوماتك الشخصية</a><span class="con"><i class="nc-icon nc-bank"></i>
            </span>
      ...
      <?php // style="text-align:right"?>
        ...
        <h1 style="font-size:2vw" class="text-center add"> Edit your login information</h1>
        <?php echo $success;?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          <label for="">email </label>
          <input type="email" name="email" value="<?php echo $emailholder;?>" style="border:<?php echo $colorborderemail;?>"  id="" placeholder="New-Email" class='form-control'>
          <div class="err"><?php echo $erremail;?></div>
          <label for="">password</label>
          <input type="password" name="password"value="<?php echo $passholder;?>"  style="border:<?php echo $colorborderpassword?>" id=""placeholder="New-Password"  class='form-control'>
          <div class="err"><?php echo $errpassword;?></div>
          <input type="submit" value="edit your data " style="float:unset;margin:1.5vw 13vw 1vw" name='editadmin' class='btn btn-success text-center'>
          </form>   
        </div>
      </div>
          ...
          <div class="row">
            <nav class="footer-nav">
              <ul>
                ...
                <li ><a style="color:#8d5e0a; border:1px solid #8d5e0a"><?php echo $admin;?></a></li>
                <li> <a href="addadmin.php" class='addadmin' >add new admin</a></li>
