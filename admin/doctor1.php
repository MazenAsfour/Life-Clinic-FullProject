  ...
  <li class="mazen2">
    ...
    <a href="javascript:;">
        ...
        <ul class="list3">
          ...
          <li><a href="doctor1.php" class="list h active">تعديل العضو الأول</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="name"  id="" value='<?php echo $doctor1name;?>' class='form-control'>
          <label for="">عمر الدكتورة </label>
          <input type="text" name="age"style="text-align:left"  id="" value='<?php echo $doctor1age;?>' class='form-control'>
          <label for="">صورة الدكتورة </label>
          <input type="file" name="img"style="text-align:right"  id="" value='<?php echo $doctor1img;?>' class='form-control'>
          <label for="">مؤهلات الدكتور </label>
          <input type="text" name="text"style="text-align:right"  id="" value='<?php echo $doctor1text;?>' class='form-control'>
          <label for="">مؤهلات الدكتور الاضافية </label>
          <input type="text" name="textextra" style="text-align:right" id="" value='<?php echo $doctor1des;?>' class='form-control'>
          
          
          <input type="submit" value="Edit" name='doctor11' class='btn btn-success text-center'>
          </form>      
      </div>
