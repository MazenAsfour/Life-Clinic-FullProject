    ...
    <li>
      <a href="javascript:;">
        ...
        <ul class="first " id="one">
          ...
          <li class=""><a href="slidertwo.php "class="active">تعديل سلايدر الثاني</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="text" style="text-align:right" id="" value='<?php echo $slideronetext2;?>' class='form-control'>
          <label for="">الصورة</label>
          <input type="file" name="img" id="" value='<?php echo $slideroneimg2;?>' class='form-control'>
          <input type="submit" value="Edit" name='slidertwo' class='btn btn-success text-center'>
          </form>   
      </div>
