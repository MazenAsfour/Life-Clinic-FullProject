...
<div class="sidebar-wrapper">
  ...
  <li class="mazen2">
    ...
    <li>
      <a href="javascript:;">
        ...
        <ul class="first " id="one">
          ...
          <li><a href="doctor4.php"class="active">تعديل الدكتور الرابع</a></li>
          </ul>
          </li>  
    ...
    <a href="javascript:;">
        <i class="nc-icon nc-diamond"></i>
        <p onclick="show3()" class="cl3 h active" >الأعضاء<bold class="a active"><</bold></p></a>
        <ul class="list3">
          ...
          <li><a href="doctor4.php" class="list h active">تعديل العضو الرابع</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="name"  id="" value='<?php echo $doctor4name;?>' class='form-control'>
          <label for="">عمر الدكتورة </label>
          <input type="text" name="age"style="text-align:left"  id="" value='<?php echo $doctor4age;?>' class='form-control'>
          <label for="">صورة الدكتورة </label>
          <input type="file" name="img"style="text-align:right"  id="" value='<?php echo $doctor4img;?>' class='form-control'>
          <label for="">مؤهلات الدكتور </label>
          <input type="text" name="text"style="text-align:right"  id="" value='<?php echo $doctor4text;?>' class='form-control'>
          <label for="">مؤهلات الدكتور الاضافية </label>
          <input type="text" name="textextra" style="text-align:right" id="" value='<?php echo $doctor4des;?>' class='form-control'>
          
          
          <input type="submit" value="Edit" name='doctor4' class='btn btn-success text-center'>
          </form>      
      </div>
