    ...
    <li>
      <a href="javascript:;">
        ...
        <ul class="first " id="one">
          ...
          <li><a  class="list h  seredit active">خدمات العيادة<bold class="ab active"><</bold></a>
          <ul class="services" style="display: none;">
            ...
            <li><a href="ser2.php"class="active">تعديل الخدمة الثانية</a></li>
          ...
          <ul class="feedback" style="display: none;">
            ...
            <li><a href="feed1">تعديل التغذية الاولى</a></li>
            <li><a href="feed2">تعديل التغذية الثانية</a></li>
            <li><a href="feed3">تعديل التغذية الثالثة</a></li>
            <li><a href="feed4">تعديل التغذية الرابعة</a></li>
            <li><a href="feed5">تعديل التغذية الخامسة</a></li>
          </ul>
          </li>  
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="header"style="text-align:right"  id="" value='<?php echo $ser2;?>' class='form-control'>
          <label for="">وصف المحتوى</label>
          <input type="text" name="text" id=""style="text-align:right" value='<?php echo $ser2des;?>' class='form-control'>
          <input type="submit" value="Edit" name='ser2' class='btn btn-success text-center'>
          </form>   
      </div>
