  ...
  <li class="mazen2">
    ...
    <div class="main-panel" style="height: 200vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        ...
        <label for=""> السؤال الثالث </label>
          <input type="text" name="q11"style="text-align:right" id="" value='<?php echo $q3;?>' class='form-control'>
          <label for=""> الأجابة الأولى     </label>
          <input type="text" name="a1" id=""style="text-align:right" value='<?php echo $q31;?>' class='form-control'>
          <label for=""> الأجابة الثانية  </label>
          <input type="text" name="a2" id=""style="text-align:right" value='<?php echo $q32;?>' class='form-control'> 
          <label for=""> الأجابة الثالثة  </label>
          <input type="text" name="a3" id=""style="text-align:right" value='<?php echo $q33;?>' class='form-control'>
          <label for=""> الاجابة الرابعة  </label>
          <input type="text" name="a4" id=""style="text-align:right" value='<?php echo $q34;?>' class='form-control'>

          <input type="submit" value="Edit" name='q3' class='btn btn-success text-center'>
          </form>   
          <img src="divider.svg" style="width:70%;margin:1vw 9vw" alt="">
          <form action="<?php echo $_SERVER['PHP_SELF'];?>">
        <label for=""> السؤال الرابع </label>
          <input type="text" name="q11"style="text-align:right" id="" value='<?php echo $q4;?>' class='form-control'>
          <label for=""> الأجابة الأولى     </label>
          <input type="text" name="a1" id=""style="text-align:right" value='<?php echo $q41;?>' class='form-control'>
          <label for=""> الأجابة الثانية  </label>
          <input type="text" name="a2" id=""style="text-align:right" value='<?php echo $q42;?>' class='form-control'> 
          <label for=""> الأجابة الثالثة  </label>
          <input type="text" name="a3" id=""style="text-align:right" value='<?php echo $q43;?>' class='form-control'>
          <label for=""> الاجابة الرابعة  </label>
          <input type="text" name="a4" id=""style="text-align:right" value='<?php echo $q44;?>' class='form-control'>

          <input type="submit" value="Edit" name='q4' class='btn btn-success text-center'>
            </form>
      </div>
