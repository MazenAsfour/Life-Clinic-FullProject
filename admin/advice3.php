      ...
      <li>
       ...
       <li>
        ...
        <ul class="advice1" style="display:none">
          ...
          <li><a href="advice3.php" class="list h active">الاكتئاب المتوسط</a></li>
    ...
    <div class="main-panel" style="height: 110vh;text-align: right;">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand header1"style='color:#745b19' >اكتئاب متوسط  </a><span class="con">              <i class="nc-icon nc-bank"></i>
            </span>
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="a1"style="text-align:right"  id="" value='<?php echo $advice31;;?>' class='form-control'>
          <label for="">النصيحة الثانية </label>
          <input type="text" name="a2"style="text-align:right" id="" value='<?php echo $advice32;?>' class='form-control'>
          <label for="">النصيحة الثالثة</label>
          <input type="text" name="a3"style="text-align:right"  id="" value='<?php echo $advice33;?>' class='form-control'>
          <label for=""> النصيحة الرابعة</label>
          <input type="text" name="a4"style="text-align:right"  id="" value='<?php echo $advice34;?>' class='form-control'>
     
          <input type="submit" value="Edit" name='advice3' class='btn btn-success text-center'>
          </form>   
      </div>
