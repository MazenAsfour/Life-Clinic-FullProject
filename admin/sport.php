...
<div class="sidebar-wrapper">
  ...
  <li class="mazen2">
    ...
    <li>
        <a href="javascript:;">
        <i class="nc-icon nc-diamond"></i>
        <p onclick="show4()" class="cl4 h active">معلومات عنا <bold class="a active"><</bold></p></a>
        <ul class="list4">
          ...
          <li><a href="sport.php" class="list h active">التمارين الرياضية</a></li>
        </ul>
    </li>
    <li>
      <a href="javascript:;">
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand header1"style='color:#745b19' >  معلومات  عنا </a><span class="con">              <i class="nc-icon nc-bank"></i>
            </span>
      ...
      <?php // style="text-align:right"?>
        ...
        <label for="">العنوان </label>
          <input type="text" name="header"style="text-align:right" id="" value='<?php echo $aboutheader4;?>' class='form-control'>
          <label for=""> الصورة  </label>
          <input type="file" name="img"style="text-align:right"  id="" value='<?php echo $aboutimg4;?>' class='form-control'>
          <label for="">الوصف </label>
          <input type="text" name="text" id="" value='<?php echo $abouttext4;?>' class='form-control'>
          <input type="submit" value="Edit" name='sport' class='btn btn-success text-center'>
          </form>   
      </div>
