  ...
  <li class="mazen2">
    ...
    <li>
      <a href="javascript:;">
        ...
        <li><a href="qexam.php" >تعديل وصف الدخول الى الاختبار  </a></li>
          ...
          <li><a href="q78.php"class="active">تعديل السؤال السابع والثامن</a></li>
    ...
    <div class="main-panel" style="height: 200vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        ...
        <label for=""> السؤال السابع </label>
          <input type="text" name="q11"style="text-align:right" id="" value='<?php echo $q7;?>' class='form-control'>
          <label for=""> الأجابة الأولى     </label>
          <input type="text" name="a1" id=""style="text-align:right" value='<?php echo $q71;?>' class='form-control'>
          <label for=""> الأجابة الثانية  </label>
          <input type="text" name="a2" id=""style="text-align:right" value='<?php echo $q72;?>' class='form-control'> 
          <label for=""> الأجابة الثالثة  </label>
          <input type="text" name="a3" id=""style="text-align:right" value='<?php echo $q73;?>' class='form-control'>
          <label for=""> الاجابة الرابعة  </label>
          <input type="text" name="a4" id=""style="text-align:right" value='<?php echo $q74;?>' class='form-control'>

          <input type="submit" value="Edit" name='q7' class='btn btn-success text-center'>
          </form>   
          <img src="divider.svg" style="width:70%;margin:1vw 9vw" alt="">
          <form action="<?php echo $_SERVER['PHP_SELF'];?>">
        <label for=""> السؤال الثامن </label>
          <input type="text" name="q11"style="text-align:right" id="" value='<?php echo $q8;?>' class='form-control'>
          <label for=""> الأجابة الأولى     </label>
          <input type="text" name="a1" id=""style="text-align:right" value='<?php echo $q81;?>' class='form-control'>
          <label for=""> الأجابة الثانية  </label>
          <input type="text" name="a2" id=""style="text-align:right" value='<?php echo $q82;?>' class='form-control'> 
          <label for=""> الأجابة الثالثة  </label>
          <input type="text" name="a3" id=""style="text-align:right" value='<?php echo $q83;?>' class='form-control'>
          <label for=""> الاجابة الرابعة  </label>
          <input type="text" name="a4" id=""style="text-align:right" value='<?php echo $q84;?>' class='form-control'>

          <input type="submit" value="Edit" name='q8' class='btn btn-success text-center'>
            </form>
      </div>
