...
<body class=""style="height:180vh !important">
  <div class=" ">
...
<div class="sidebar-wrapper" style="position:relative">
  ...
  <li class="mazen2">
    ...
    <li>
      <a href="javascript:;">
        <i class="nc-icon nc-diamond"></i>
        <p class="cl h active">الصفحة الرئيسية <bold class="a active"><</bold></p></a>
        <ul class="first " id="one">
          ...
          <li><a  class="list h prices1 active">اسعار الجلسات  <bold class="ab active"><</bold></a>
          <ul class="prices" style="display: none;">
            <li><a href="session1.php" class="active">تعديل الجلسة الأولى</a></li>
    ...
    <div class="main-panel" style="height: 180vh;text-align: right;">
      <!-- Navbar -->
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand header1"style='color:#745b19' > الصفحة الرئيسية  </a><span class="con">              <i class="nc-icon nc-bank"></i>
            </span>
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="name"style="text-align:right"  id="" value='<?php echo $sessionname;;?>' class='form-control'>
          <label for="">سعر الجلسة</label>
          <input type="number" name="price"style="text-align:right" id="" value='<?php echo $session1price;?>' class='form-control'>
          <label for="">الوقت</label>
          <input type="text" name="time"  id="" value='<?php echo $session1det1;?>' class='form-control'>
          <label for="">الخاصية الاولى</label>
          <input type="text" name="text1"style="text-align:right"  id="" value='<?php echo $session2det1;?>' class='form-control'>
          <label for="">الخاصية الثانية</label>
          <input type="text" name="text2"style="text-align:right"  id="" value='<?php echo $session3det1;?>' class='form-control'>
          <label for="">الخاصية الثالثة</label>
          <input type="text" name="text3" style="text-align:right" id="" value='<?php echo $session4det1;?>' class='form-control'>
          <label for="">الخاصية الرابعة</label>
          <input type="text" name="text4" style="text-align:right" id="" value='<?php echo $session5det1;?>' class='form-control'>
          
          <input type="submit" value="Edit" name='session1' class='btn btn-success text-center'>
          </form>   
      </div>
