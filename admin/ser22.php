...
<head>
  ...
  <title>
   edit subwebite services-service 2
  </title>
  ...
  <li class="mazen2">
    ...
    <li>
      <a >
        ...
        <ul class="list2" > 
          ...
          <li><a href="ser22.php" class="list h active">تعديل الخدمة الثانية</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        ...
        <label for="">اسم الخدمة التانية</label>
          <input type="text" name="" style="text-align:right" id="" value='<?php echo $ser1;?>' class='form-control' readonly>
          <label for=""> صورة الخدمة التانية</label>
          <input type="file" name="img"  id="" value='<?php echo $seradvimg2;?>' class='form-control'>
          <label for="">الوصف </label>
          <input type="text" name="text" id="" value='<?php echo $seradv2;?>' class='form-control'>
          <input type="submit" value="Edit" name='ser22' class='btn btn-success text-center'>
          </form>   
      </div>
