      ...
      <a href="javascript:;">
        ...
        <ul class="first " id="one">
          ...
          <ul class="services" style="display: none;">
            ...
            <li><a href="ser1.php" class="active">تعديل الخدمة الأولى</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="header"style="text-align:right"  id="" value='<?php echo $ser1;?>' class='form-control'>
          <label for="">وصف المحتوى</label>
          <input type="text" name="text" id=""style="text-align:right" value='<?php echo $ser1des;?>' class='form-control'>
          <input type="submit" value="Edit" name='ser1' class='btn btn-success text-center'>
          </form>   
      </div>
