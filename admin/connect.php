...
<div class="sidebar-wrapper">
  ...
  <li class="mazen2">
    ...
    <li><a href="advice5.php" class="list h">الاكتئاب الشديد جدا</a></li>    </ul>
        ...
        <a href="about.php">
        <i class="nc-icon nc-diamond"></i></a>
        <p><a href="connect.php" class="f h active">اتصل بنا</a></p>
        </li>
    ...
    <div class="main-panel" style="height: 180vh;text-align: right;width:82% !important;">
      <!-- Navbar -->
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand header1"style='color:#745b19' >  معلومات الاتصال    </a><span class="con">              <i class="nc-icon nc-bank"></i>
            </span>
      ...
      <!-- End Navbar -->
      <div class="content" style="margin-top:4.2vw">
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
        <label for="" style="float:right">وقت دوام العيادة </label>
          <input type="text" name="tmar"style="text-align:right" id="" value='<?php echo $timeopenar;?>' class='form-control'>
        <label for="" style="float:right"> رقم العيادة </label>
          <input type="text" name="nar"style="text-align:right" id="" value='<?php echo $numberar;?>' class='form-control'>
          <label for=""style="float:right" >موقع العيادة</label>
          <input type="text" name="lar"style="text-align:right" id="" value='<?php echo $locationar;?>' class='form-control'>
          <label for="">time open clinic  </label>
          <input type="text" name="tm" id="" value='<?php echo $timeopen;?>' class='form-control'>
          <label for="">Number phone</label>
          <input type="text" name="n" id="" value='<?php echo $number;?>' class='form-control'>
          <label for="">location</label>
          <input type="text" name="l" id="" value='<?php echo $location;?>' class='form-control'>
          <input type="submit" value="Edit" name='connect' class='btn btn-success text-center'>
          </form>   
      </div>
