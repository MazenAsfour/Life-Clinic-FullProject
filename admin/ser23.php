...
<head>
  ...
  <title>
   edit subwebite services-service 3
  </title>
  ...
  <li class="mazen2">
    ...
    <li>
      <a >
        ...
        <ul class="list2" > 
          ...
          <li><a href="ser23.php" class="list h active">تعديل الخدمة الثالثة</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        ...
        <label for=""> اسم الخدمة الثالثة</label>
          <input type="text" name="" style="text-align:right" id="" value='<?php echo $ser3;?>' class='form-control' readonly>
          <label for=""> صورة الخدمة الثالثة</label>
          <input type="file" name="img"  id="" value='<?php echo $seradvimg3;?>' class='form-control'>
          <label for="">الوصف </label>
          <input type="text" name="text" id="" value='<?php echo $seradv3;?>' class='form-control'>
          <input type="submit" value="Edit" name='ser23' class='btn btn-success text-center'>
          </form>   
      </div>
