...
<head>
  ...
  <title>
   edit subwebite services-service 1
  </title>
  ...
  <li class="mazen2">
    ...
    <li>
      <a >
        ...
        <ul class="list2" > 
          <li><a href="ser21.php" class="list h active">تعديل الخدمة الأولى</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        ...
        <label for=""> اسم الخدمة الاولى</label>
          <input type="text" name="" style="text-align:right" id="" value='<?php echo $ser1;?>' class='form-control' readonly>
          <label for=""> صورة الخدمة الاولى</label>
          <input type="file" name="img"  id="" value='<?php echo $seradvimg1;?>' class='form-control'>
          <label for="">الوصف </label>
          <input type="text" name="text" id="" value='<?php echo $seradv1;?>' class='form-control'>
          <input type="submit" value="Edit" name='ser21' class='btn btn-success text-center'>
          </form>   
      </div>
