  ...
  <li class="mazen2">
    ...
    <li>
      ...
      <li>
        ...
        <li><a href="know5.php"class="active">متى يجب مراجعة الطبيب</a></li>
    ...
    <div class="main-panel" style="height: 150vh;text-align: right;width:82% !important;">
      ...
      <?php // style="text-align:right"?>
        <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="header"style="text-align:right"  id="" value='<?php echo $when;?>' class='form-control'>
          <label for=""> التفكير الأول </label>
          <input type="text" name="r1" id=""style="text-align:right" value='<?php echo $when1;;?>' class='form-control'>
          <label for=""> التفكير التاني   </label>
          <input type="text" name="r2" id=""style="text-align:right" value='<?php echo $when2;;?>' class='form-control'>
          <label for=""> التفكير الثالث</label>
          <input type="text" name="r3" id=""style="text-align:right" value='<?php echo $when3;;?>' class='form-control'>
         
          <input type="submit" value="Edit" name='know5' class='btn btn-success text-center'>
          </form>   
      </div>
