  ...
  <li class="mazen2">
    ...
    <li><a href="advice5.php" class="list h">الاكتئاب الشديد جدا</a></li>    </ul>
      ...
      <li>
        <a href="">
        <i class="nc-icon nc-diamond"></i></a>
        <p ><a href="footer.php" class="f h active">روابط السوشال ميديا</a>
        </p>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand header1"style='color:#745b19' >  السوشال ميديا   </a><span class="con">              <i class="nc-icon nc-bank"></i>
            </span>
      ...
      <?php // style="text-align:right"?>
        ...
        <label for="">facebook </label>
          <input type="text" name="face" id="" value='<?php echo $facebook;?>' class='form-control'>
          <label for="">instagram</label>
          <input type="text" name="insta" id="" value='<?php echo $instagram;?>' class='form-control'>
          <label for="">twitter  </label>
          <input type="text" name="tw" id="" value='<?php echo $twitter;?>' class='form-control'>
          <label for="">telegram</label>
          <input type="text" name="tele" id="" value='<?php echo $telegram;?>' class='form-control'>
          <input type="submit" value="Edit" name='social' class='btn btn-success text-center'>
          </form>   
      </div>
