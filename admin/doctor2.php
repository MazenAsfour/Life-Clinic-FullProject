  ...
  <li class="mazen2">
    ...
    <li>
      <a href="javascript:;">
        ...
        <ul class="first " id="one">
          ...
          <li><a href="doctor2.php" class="active">تعديل الدكتور الثاني</a></li>
    ...
    <a href="javascript:;">
        ...
        <ul class="list3">
          ...
          <li><a href="doctor2.php" class="list h active">تعديل العضو الثاني</a></li>
    ...
    <div class="main-panel" style="height: 100vh;text-align: right;width:82% !important;">
      ...
      <form action="<?php echo $_SERVER['PHP_SELF'];?>">
          ...
          <input type="text" name="name"  id="" value='<?php echo $doctor2name;?>' class='form-control'>
          <label for="">عمر الدكتورة </label>
          <input type="text" name="age"style="text-align:left"  id="" value='<?php echo $doctor2age;?>' class='form-control'>
          <label for="">صورة الدكتورة </label>
          <input type="file" name="img"style="text-align:right"  id="" value='<?php echo $doctor2img;?>' class='form-control'>
          <label for="">مؤهلات الدكتور </label>
          <input type="text" name="text"style="text-align:right"  id="" value='<?php echo $doctor2text;?>' class='form-control'>
          <label for="">مؤهلات الدكتور الاضافية </label>
          <input type="text" name="textextra" style="text-align:right" id="" value='<?php echo $doctor2des;?>' class='form-control'>
          
          
          <input type="submit" value="Edit" name='doctor2' class='btn btn-success text-center'>
          </form>      
      </div>
