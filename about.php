    ...
    <nav class="headerstags">
        ...
        <div class="first" >
                ...
                <div class="second">
                    ...
                    <a href="about.php" class="hvr-grow active">معلومات عنا</a>
...
<section class="headerstags">
    <div class="about">
        <div class="container">
            <img src="img/<?php echo $aboutimg1;?> " width="100%" alt="">
            <p><?php echo $aboutheader1;?> </p>
        </div>
    </div>
    <div class="col-lg-12">
        <div class="container">
        <img src="assest/divider.svg" class="dividerabout"  alt="">
        </div>
    </div>
    <div class="about1">
        <div class="container">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 leftabout">
               
               <div class="leftaboutdif">
                <h1><?php echo $aboutheader2;?> </h1>
                <h4>
                <?php echo $abouttext2;?> 
                </h4>
                </div>
                <div class="leftaboutdif">
                    <h1><?php echo $aboutheader3;?> </h1>
                    <h4><?php echo $abouttext3;?> </h4>
                    </div>
                <div class="leftaboutdif">
                <h1><?php echo $aboutheader4;?>  </h1>
                <h4>
                <?php echo $abouttext4;?> 
                </h4>
                </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <img src="img/<?php echo $aboutimg2;?> " alt="">
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <img src="img/<?php echo $aboutimg4;?> " alt="">
            </div>
        </div>
    </div>
...
<div class="scr">
    ...
    <footer class="headerstags">
        ...
        <div class="firstfooter">
           <ul>
           <li><a href="<?php echo $facebook;?>"class="hvr-grow">Facebook</a></li>
                <li><a href="">|</a></li>
