    ...
    <nav class="headerstags">
        ...
        <div class="first" >
                ...
                <div class="second">
                    ...
                    <a href="ourteam.php" class="hvr-grow active">الاعضاء</a>
...
<section class="<?php echo $headertag;;?>">
    ...
    <div class="container">
        ...
        <div class="itemteam text-center">
            ...
            <h1 class="name"><?php echo $doctor1name;?></h1>
            <hr>
            
            <p class="qualification">
            <?php echo $doctor1des;?>
            </p>  
            <h3 class="age">Age doctor : <?php echo $doctor1age;?></h3>
            <div class="iconsdoctor">
                <i class="fa fa-instagram difi" aria-hidden="true"></i>
                <i class="fa fa-facebook-square difi" aria-hidden="true"></i>
                <i class="fa fa-twitter-square difi" aria-hidden="true"></i>
                <i class="fa fa-google difi" aria-hidden="true"></i>
        ...
        <div class="itemteam text-center display">
            <div class="col-lg-12">
              <div class="container">  
             
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <h1 class="name"><?php echo $doctor2name;?></h1>
            <hr>
            
            <p class="qualification">
            <?php echo $doctor2des;?>
            </p>  
            <h3 class="age">Age doctor : <?php echo $doctor2age;?></h3>
            <div class="iconsdoctor">
                <i class="fa fa-instagram difi" aria-hidden="true"></i>
                <i class="fa fa-facebook-square difi" aria-hidden="true"></i>
                <i class="fa fa-twitter-square difi" aria-hidden="true"></i>
        ...
        <div class="itemteam text-center display">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <h1 class="name"><?php echo $doctor3name;?></h1>
            <hr>
            
            <p class="qualification">
            <?php echo $doctor3des;?>
            </p>  
            <h3 class="age">Age doctor : <?php echo $doctor3age;?></h3>
            <div class="iconsdoctor">
                <i class="fa fa-instagram difi" aria-hidden="true"></i>
                <i class="fa fa-facebook-square difi" aria-hidden="true"></i>
                <i class="fa fa-twitter-square difi" aria-hidden="true"></i>
        ...
        <div class="itemteam text-center display">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <h1 class="name"><?php echo $doctor4name;?></h1>
            <hr>
            
            <p class="qualification">
            <?php echo $doctor4des;?>
            </p>  
            <h3 class="age">Age doctor : <?php echo $doctor4age;?></h3>
            <div class="iconsdoctor">
                <i class="fa fa-instagram difi" aria-hidden="true"></i>
                <i class="fa fa-facebook-square difi" aria-hidden="true"></i>
                <i class="fa fa-twitter-square difi" aria-hidden="true"></i>
        ...
        <div class="move">
            <i class="fa fa-angle-right next hvr-grow" aria-hidden="true" onclick="sliderourteam(1)"></i>
            <i class="fa fa-angle-left left hvr-grow" aria-hidden="true" onclick="sliderourteam(-1)"></i>
        </div>
    </div>
...
<div class="scr">
    ...
    <script>
        var index=1;
        const teams=document.querySelectorAll('.itemteam');
        console.log(teams);
        function sliderourteam(c){
        index=index+c;
        ...
        teams[index-1].style.display='block';
